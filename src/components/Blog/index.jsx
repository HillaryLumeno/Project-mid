    ...
    <div className="blog" id="blog">
                ...
                <div className="row">
                    ...
                    <div className="blog-item wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <img src="https://github.com/BrianGustafBirahy/latihan-git/blob/hill/public/img/TouMinahasa.png?raw=true" alt="Blog" />
                        </div>
                    ...
                    <div className="blog-item wow fadeInUp" data-wow-delay="0.3s">
                        <div className="blog-img">
                        <img src="https://github.com/BrianGustafBirahy/latihan-git/blob/hill/public/img/Quantum.png?raw=true" alt="Blog" />
                        </div>
                        <div className="blog-text">
